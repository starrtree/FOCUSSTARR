    ...
    return (
      <div className="bg-white border-[2px] border-black rounded-lg overflow-hidden flex flex-col h-full transition-all duration-200 hover:shadow-[4px_4px_0_black]">
        ...
        <div className="p-4 flex-1 flex items-center justify-center">
          <div
            className="text-xs text-[var(--gray-400)] text-center"
      ...
      <div className="p-4 flex-1 flex items-center justify-center">
        <div className="flex items-center gap-5">
          ...
          <svg viewBox="0 0 100 100" className="w-[100px] h-[100px] border-[2px] border-black rounded-full -rotate-90 transition-transform duration-300 hover:scale-105">
            <circle cx="50" cy="50" r={radius} fill="none" stroke="#e2e2de" strokeWidth="16" />
          ...
          <div className="flex-1">
            {Object.entries(counts).map(([status, count]) => (
              <div 
                key={status} 
                className="flex items-center gap-2 text-xs mb-1.5 last:mb-0 cursor-pointer hover:translate-x-1 transition-transform duration-150" 
                style={{ fontFamily: 'var(--font-space-mono), monospace' }}
              >
                <div
