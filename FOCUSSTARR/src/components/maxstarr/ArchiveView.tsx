      ...
      <div className="bg-white border-[2px] border-black rounded-lg shadow-[6px_6px_0_black] overflow-hidden mb-4">
        <div className="bg-black px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Archive className="w-5 h-5 text-[var(--gray-400)]" />
            <h2
          ...
          <div className="text-xs text-[var(--gray-400)]" style={{ fontFamily: 'var(--font-space-mono), monospace' }}>
          ...
          {([
            ...
            <button
              ...
              className={cn(
                ...
                activeTab === tab.key 
                  ? "bg-[var(--brand-red)] text-white border-b-[3px] border-black -mb-[2px]" 
            ...
            >
              ...
              <span className={cn(
                ...
                activeTab === tab.key ? "bg-white/20" : "bg-[var(--gray-200)]"
              )}>
                {tab.count}
              </span>
            </button>
          ...
          <div>
            {archivedTasks.length === 0 ? (
              <div className="p-8 text-center">
                <CheckCircle className="w-12 h-12 mx-auto mb-3 text-[var(--gray-300)]" />
                <p className="text-[var(--gray-400)] text-sm" style={{ fontFamily: 'var(--font-space-mono), monospace' }}>
                  No sacrificed tasks
                </p>
                <p className="text-xs text-[var(--gray-400)] mt-1" style={{ fontFamily: 'var(--font-space-mono), monospace' }}>
              ...
              <div className="divide-y divide-[var(--gray-200)]">
                {archivedTasks.map(task => (
                  <div key={task.id} className="p-4 flex items-center gap-4 hover:bg-[var(--gray-100)] transition-colors group">
                    <div className="flex-1 min-w-0">
                      <div className="font-medium text-sm line-through text-[var(--gray-400)] truncate">
                        {task.title}
                      </div>
                      <div className="text-[10px] text-[var(--gray-400)] mt-0.5" style={{ fontFamily: 'var(--font-space-mono), monospace' }}>
                    ...
                    <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button
                        ...
                        className="flex items-center gap-1 px-2 py-1 bg-[var(--brand-blue)] text-white text-[10px] rounded border-[1.5px] border-black hover:bg-[var(--brand-blue-light)] transition-colors cursor-pointer"
                        style={{ fontFamily: 'var(--font-space-mono), monospace' }}
                      >
        ...
        {activeTab === 'projects' && (
          <div>
            {archivedProjects.length === 0 ? (
              <div className="p-8 text-center">
                <FolderOpen className="w-12 h-12 mx-auto mb-3 text-[var(--gray-300)]" />
                <p className="text-[var(--gray-400)] text-sm" style={{ fontFamily: 'var(--font-space-mono), monospace' }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
                {archivedProjects.map(project => (
                  <div key={project.id} className="p-4 border-[2px] border-[var(--gray-300)] rounded-lg bg-[var(--gray-100)] group relative">
                    ...
                    <div className="text-[10px] text-[var(--gray-400)]" style={{ fontFamily: 'var(--font-space-mono), monospace' }}>
                      {project.due}
                    </div>
        ...
        {activeTab === 'documents' && (
          <div>
            {archivedDocuments.length === 0 ? (
              <div className="p-8 text-center">
                <FileText className="w-12 h-12 mx-auto mb-3 text-[var(--gray-300)]" />
                <p className="text-[var(--gray-400)] text-sm" style={{ fontFamily: 'var(--font-space-mono), monospace' }}>
              ...
              <div className="divide-y divide-[var(--gray-200)]">
                {archivedDocuments.map(doc => (
                  <div key={doc.id} className="p-4 flex items-center gap-4 hover:bg-[var(--gray-100)] transition-colors group">
