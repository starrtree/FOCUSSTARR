...
import { Star, Zap, FileText, Settings, Menu, X, FolderOpen, Folder, GripVertical, Pencil, MoreVertical, Archive } from 'lucide-react';
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "border-l-[3px] border-transparent",
        "text-white/80 hover:bg-white/10 hover:text-white",
        active && "bg-white/10 text-white border-l-[3px] border-[var(--brand-yellow)]",
        isDragging && "opacity-50 bg-white/20",
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      >
        {/* Logo */}
        <div className="p-5 border-b-[2px] border-black bg-black">
          <h1
            className="text-[28px] leading-tight text-[var(--brand-yellow)] tracking-[2px]"
            style={{ fontFamily: 'Bebas Neue, sans-serif' }}
          >
            MAX<br />STARR ★
          </h1>
          <span
            className="text-[10px] text-[var(--gray-400)] tracking-[1px] mt-0.5 block"
        ...
        <div className="py-3 border-b border-white/10">
          <div
            className="px-4 pb-1.5 text-[9px] text-white/40 tracking-[2px] uppercase"
            style={{ fontFamily: 'var(--font-space-mono), monospace' }}
          >
            Workspace
          </div>
        ...
        <div className="py-3 border-b border-white/10">
          <div
            className="px-4 pb-1.5 text-[9px] text-white/40 tracking-[2px] uppercase flex items-center gap-2"
            style={{ fontFamily: 'var(--font-space-mono), monospace' }}
          >
          ...
          <div className="flex flex-wrap gap-2 px-4 pb-3">
            {tags.map((tag) => (
              <div
                ...
                className="text-[10px] px-2 py-1 bg-black/20 border border-white/20 rounded text-white cursor-pointer transition-all duration-150 hover:bg-[var(--brand-yellow)] hover:text-black hover:border-[var(--brand-yellow)] hover:-translate-y-0.5"
                style={{ fontFamily: 'var(--font-space-mono), monospace' }}
              >
                #{tag}
              </div>
